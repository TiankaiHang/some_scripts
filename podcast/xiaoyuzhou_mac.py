...
@click.option("-c", "--cookies_file", help="Path to JSON file containing cookies")
...
if __name__ == "__main__":
    r"""
    demo usage:
        python xiaoyuzhou_mac.py download-audio --url "https://www.xiaoyuzhoufm.com/episode/670099d36c7f817786da1e4a" --output_path "downloaded_audio"
        python xiaoyuzhou_mac.py transcribe --audio_path "downloaded_audio/ltwjjENqEP3IRbUOoYOD2s01Yi2x.m4a"
    """
    cli()
